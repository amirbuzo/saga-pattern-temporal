package com.saga.bitbucket.persistence.repository;
...
import com.saga.bitbucket.persistence.mapper.PullRequestPersistableMapper;
...
public class PullRequestRepositoryImpl implements PullRequestRepository {
    ...
    public Optional<PullRequestDto> getByprRequestId(String prRequestId) {
        return pullRequestMongoRepository.findByprRequestId(prRequestId).stream().map(PullRequestPersistableMapper.MAPPER::map).findFirst();
    }
}
