package com.ikubinfo.build.application.domain.service.impl;

import java.util.UUID;

import com.ikubinfo.build.application.domain.service.BuildService;
import com.ikubinfo.build.config.ApplicationProperties;

import lombok.RequiredArgsConstructor;
import lombok.SneakyThrows;
import lombok.extern.slf4j.Slf4j;

/** Mock implementation to represent call to external service to initiate building */
@Slf4j
