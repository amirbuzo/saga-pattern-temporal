...
public class BuildActivitiesImpl implements BuildActivities {
    ...
    public void buildProject(JiraTaskDTO prRequestDTO) {
        ...
        var build = BuildArtifactDto.builder().prRequestId(prRequestDTO.getJiraTaskId()).branchId(prRequestDTO.getBranchId()).path(prRequestDTO.getPath()).trackingId(trackingId)
                .build();
